...
@pytest.mark.parametrize(
    ...
    [
        (
            Yemeksepeti_J, Getir_J, Migros_J, pseudo_sepet_icerik, pseudo_food_var, {"Cheeseburger": 10}, pseudo_miktar_var, {"Cheeseburger": {"Yemeksepeti": 350, "Getir": 330, "MigrosYemek": 330}}, 9
        )
    ]
)
def test_yemek_ekle(joker_yemeksepeti, joker_getir, joker_migros, sepet_icerik, selected_food_var: tk.StringVar,
    ...
    yemek_sil(joker_yemeksepeti, joker_getir, joker_migros, sepet_icerik, selected_food_var,
